...
/** listinterfaceInfoByPage POST /api/userInterfaceInfo/list */
...
/** listMyinterfaceInfoByPage POST /api/userInterfaceInfo/list/page */
export async function listMyinterfaceInfoByPageUsingPOST1(
  body: API.UserInterfaceInfoQueryRequest,
  options?: { [key: string]: any },
) {
